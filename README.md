...
Because this is a simple static site, you can preview it by opening `index.html`, `ikes-trades.html`, or `stock-picks.html` in a browser, or by serving the folder with any lightweight static server.
