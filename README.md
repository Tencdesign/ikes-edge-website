...
Because this is a simple static site, you can preview it by opening `index.html` or `ikes-trades.html` in a browser, or by serving the folder with any lightweight static server.
